      ...
      <section className="relative min-h-[75vh] flex items-center overflow-hidden">
        ...
        <div className="container relative z-10 py-16">
          <div className="max-w-4xl mx-auto">
            ...
            {/* Heading */}
            <h1 className="text-center text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight mb-6 animate-fade-in" style={{ animationDelay: '0.1s' }}>
              Help Someone Today
              <br />
            ...
            {/* Description */}
            <p className="text-center text-base md:text-lg lg:text-xl text-muted-foreground max-w-2xl mx-auto mb-10 animate-fade-in" style={{ animationDelay: '0.2s' }}>
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mb-12 animate-fade-in" style={{ animationDelay: '0.3s' }}>
              <Button 
                size="lg" 
                className="btn-primary h-12 px-8 text-base gap-2 w-full sm:w-auto"
              ...
              <Button 
                size="lg"
                variant="outline" 
                className="btn-secondary h-12 px-8 text-base gap-2 w-full sm:w-auto"
        ...
        <div className="container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-5">
            {[
              ...
              <div 
                key={i} 
                className="feature-card text-center animate-fade-in p-5"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="icon-box inline-flex items-center justify-center w-12 h-12 mb-3">
          ...
          <div className="container relative">
            <div className="flex items-end justify-between mb-10">
              <div>
                ...
                <h2 className="text-2xl md:text-3xl font-bold">Needs Immediate Help</h2>
                <p className="text-muted-foreground mt-1">These requests require urgent attention</p>
              </div>
      ...
      <section className="py-16 relative overflow-hidden">
        ...
        <div className="container relative">
          <div className="text-center mb-12">
            <div className="badge-modern mx-auto mb-4">
        ...
        <div className="container">
          <div className="flex items-end justify-between mb-10">
            <div>
              ...
              <h2 className="text-2xl md:text-3xl font-bold">Latest Requests</h2>
              <p className="text-muted-foreground mt-1">People in your community need help</p>
            </div>
          ...
          {loading ? (
            ...
            <div className="feature-card text-center py-16">
              <div className="icon-box inline-flex items-center justify-center w-16 h-16 mb-5">
                <HandHeart className="w-8 h-8 text-primary" />
              </div>
              <h3 className="text-xl font-bold mb-2">No requests yet</h3>
              <p className="text-muted-foreground mb-6">Be the first to create a request or help someone!</p>
              <Button 
      ...
      <section className="py-16 relative">
        ...
        <div className="container relative">
          <div className="text-center mb-12">
            ...
            <h2 className="text-2xl md:text-3xl font-bold mb-3">Three Simple Steps</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            {[
              ...
              <div key={i} className="relative animate-fade-in" style={{ animationDelay: `${i * 0.15}s` }}>
                ...
                <div className="feature-card text-center relative p-6">
                  <div className="absolute top-4 right-5 text-5xl font-black text-muted/50">
                    {item.step}
                  </div>
        ...
        <div className="container">
          <div className="grid md:grid-cols-3 gap-5">
            {[
              ...
              <div 
                key={i} 
                className="feature-card flex items-start gap-4 animate-fade-in p-5"
                style={{ animationDelay: `${i * 0.1}s` }}
              >
                <div className="icon-box shrink-0 w-12 h-12">
      ...
      <section className="py-16">
        <div className="container">
          <div className="relative rounded-2xl overflow-hidden">
            ...
            {/* Decorative blurs */}
            <div className="absolute -top-16 -left-16 w-56 h-56 bg-white/20 rounded-full blur-3xl" />
            ...
            <div className="relative z-10 px-8 py-14 md:px-16 md:py-20 text-center">
              ...
              <Button 
                size="lg"
                variant="secondary"
                className="h-12 px-8 font-semibold gap-2 hover:scale-105 transition-transform"
